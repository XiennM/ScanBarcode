...
fun ProductAPI.toEntity(): Product {
    return Product(
        name = this.displayName,
        brands = this.displayBrand,
        imageUrl = this.imageUrl,
        ingredients = displayIngredients,
        quantity = displayQuantity,
        categoriesTags = displayCategories,
        allergensTags = displayAllergens,
        isVegan = this.isVegan,
        isVegeterian = this.isVegetarian,
        proteins = displayProteins,
        fats = displayFats,
        carbohydrates = displayCarbohydrates,
